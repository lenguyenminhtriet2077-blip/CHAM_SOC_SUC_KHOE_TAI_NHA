...
\restrict 3TVEkWoEL5p3S9DAin4VvEXQomYHDKvQ2zi7WLjnl9KC126ORQGYgLp26HVvKvg

-- Dumped from database version 17.9
-- Dumped by pg_dump version 17.9

-- Started on 2026-05-06 18:40:54
...
--
-- TOC entry 262 (class 1255 OID 25465)
...
--
-- TOC entry 235 (class 1255 OID 25463)
...
--
-- TOC entry 257 (class 1255 OID 17266)
...
--
-- TOC entry 237 (class 1255 OID 17236)
...
--
-- TOC entry 238 (class 1255 OID 17237)
...
--
-- TOC entry 239 (class 1255 OID 17238)
...
--
-- TOC entry 255 (class 1255 OID 17263)
...
--
-- TOC entry 251 (class 1255 OID 17240)
...
--
-- TOC entry 260 (class 1255 OID 17269)
...
--
-- TOC entry 258 (class 1255 OID 17267)
...
--
-- TOC entry 261 (class 1255 OID 17270)
...
--
-- TOC entry 259 (class 1255 OID 17268)
...
--
-- TOC entry 254 (class 1255 OID 17262)
...
--
-- TOC entry 256 (class 1255 OID 17239)
...
CREATE PROCEDURE public.sp_taohoadonthanhtoan(IN p_malichhen character varying)
    ...
    AS $$
DECLARE
    v_TongTienDichVu DECIMAL(15,2);
    v_TongTienVatTu DECIMAL(15,2);
    v_HeSo DECIMAL(3,1) := 1.0;
BEGIN
    -- Tính hệ số giờ (Sau 22h)
    SELECT CASE WHEN EXTRACT(HOUR FROM ThoiGianBatDau) >= 22 THEN 1.2 ELSE 1.0 END
    INTO v_HeSo FROM LICH_HEN WHERE MaLichHen = p_MaLichHen;

    -- Tính tiền dịch vụ
    SELECT (dv.DonGiaTieuChuan * v_HeSo) INTO v_TongTienDichVu
    FROM DICH_VU dv JOIN LICH_HEN lh ON dv.MaDichVu = lh.MaDichVu
    WHERE lh.MaLichHen = p_MaLichHen;

    -- Tính tiền vật tư
    SELECT SUM(ct.SoLuong * ct.DonGiaThoiDiem) INTO v_TongTienVatTu
    FROM CHI_TIET_VAT_TU ct JOIN KET_QUA_KHAM kq ON ct.MaKetQua = kq.MaKetQua
    WHERE kq.MaLichHen = p_MaLichHen;

    -- Insert vào bảng (Lưu ý dùng || để nối chuỗi)
    INSERT INTO HOA_DON (MaHoaDon, MaLichHen, TongTienDichVu, TongTienVatTu, TongTienThanhToan, NgayLap)
    VALUES (
        'HD' || p_MaLichHen, 
        p_MaLichHen, 
        COALESCE(v_TongTienDichVu, 0), 
        COALESCE(v_TongTienVatTu, 0),
        COALESCE(v_TongTienDichVu, 0) + COALESCE(v_TongTienVatTu, 0),
        CURRENT_TIMESTAMP
    );
END;
$$;
...
--
-- TOC entry 4894 (class 2606 OID 17232)
...
--
-- TOC entry 4896 (class 2606 OID 17234)
...
--
-- TOC entry 4866 (class 2606 OID 17073)
...
--
-- TOC entry 4884 (class 2606 OID 17180)
...
--
-- TOC entry 4874 (class 2606 OID 17101)
...
--
-- TOC entry 4890 (class 2606 OID 17221)
...
--
-- TOC entry 4892 (class 2606 OID 17219)
...
--
-- TOC entry 4878 (class 2606 OID 17126)
...
--
-- TOC entry 4886 (class 2606 OID 17204)
...
--
-- TOC entry 4888 (class 2606 OID 17202)
...
--
-- TOC entry 4898 (class 2606 OID 17256)
...
--
-- TOC entry 4900 (class 2606 OID 17254)
...
--
-- TOC entry 4860 (class 2606 OID 17064)
...
--
-- TOC entry 4862 (class 2606 OID 17060)
...
--
-- TOC entry 4864 (class 2606 OID 17062)
...
--
-- TOC entry 4880 (class 2606 OID 17134)
...
--
-- TOC entry 4876 (class 2606 OID 17106)
...
--
-- TOC entry 4868 (class 2606 OID 17094)
...
--
-- TOC entry 4870 (class 2606 OID 17092)
...
--
-- TOC entry 4872 (class 2606 OID 17096)
...
--
-- TOC entry 4882 (class 2606 OID 17173)
...
--
-- TOC entry 4914 (class 2620 OID 25485)
...
--
-- TOC entry 4915 (class 2620 OID 25464)
...
--
-- TOC entry 4911 (class 2620 OID 17243)
...
--
-- TOC entry 4912 (class 2620 OID 17241)
...
--
-- TOC entry 4913 (class 2620 OID 17245)
...
--
-- TOC entry 4907 (class 2606 OID 17186)
...
--
-- TOC entry 4909 (class 2606 OID 17222)
...
--
-- TOC entry 4904 (class 2606 OID 17135)
...
--
-- TOC entry 4905 (class 2606 OID 17140)
...
--
-- TOC entry 4906 (class 2606 OID 17145)
...
--
-- TOC entry 4908 (class 2606 OID 17205)
...
--
-- TOC entry 4910 (class 2606 OID 17257)
...
--
-- TOC entry 4902 (class 2606 OID 17112)
...
--
-- TOC entry 4903 (class 2606 OID 17107)
...
-- Completed on 2026-05-06 18:40:55

--
-- PostgreSQL database dump complete
--

\unrestrict 3TVEkWoEL5p3S9DAin4VvEXQomYHDKvQ2zi7WLjnl9KC126ORQGYgLp26HVvKvg
